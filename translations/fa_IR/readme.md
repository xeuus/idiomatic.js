# اصول برنامه نویسی صریح، جاوا اسکریپت به زبان عامیانه

## مطلاب موجود در این مقاله دائما در حال بهبود است و ایده های جدید برای بهتر شدن آن همیشه برای ما خوش‌آمد است.   راه های همکاری  fork, clone, branch, commit, push, pull request.
...
## کد ها در هر پروژه‌ای باید به گونه ای نوشته شوند که انگار یک نفر تمامی آن ها را نوشته است، بدون تاثیر از آنکه هر تعداد برنامه نویس در نوشتن آنها سهیم بوده‌.

### لیست پیش رو مجموعه ای از تمرین هایی است که شخص من در نوشتن کد هایم از آنها پیروی می کنم، مشارکت در پروژه ای که من ایجاد کردم باید پیرو همین دستورالعمل ها نیز باشد.

### شخص من قصد ندارد نحوه‌ی کدنویسی‌اش را به دیگر برنامه‌نویسان و یا در پروژه های دیگر تحمیل کند، وجود یک سبک مشترک امری حیاتی است و باید مورد توجه قرار بگیرد.


> ### "بحث هایی که بر روی شیوه‌ی کد نویسی صورت می گیرد بی فایده است. باید یک شیوه کدنویسی وجود داشته باشد و تو از آن پیروی کنی."
>_ربکا_ _مورفی_

&nbsp;


> ### "بخشی از اینکه در پروژه ای موفق نقش پیشرو و مباشر را داشته باشی این است که بدانی کد نویسی به سبک شخصی خودت فکر بسیار بدی است. اگر هزار نفر قرار است کد شما را بخوانند پس برنامه‌ات را با بیشترین وضوح ممکن بنویس، نه صرفا به این خاطر که در آن میان فرد باهوش تو باشی."
>_ایدن_ _گازیت_
...
### ابزار های کد نویسی، کتب و منابع

 * [JavaScript Plugin](http://docs.codehaus.org/display/SONAR/JavaScript+Plugin) برای [Sonar](http://www.sonarsource.org/)
...
### [جاوا اسکریپت اکما ۵.۱ حاشیه نویسی شده](http://es5.github.com/)
### [جزئیات برنامه نویسی اکما، نسخه ۵.۱](http://ecma-international.org/ecma-262/5.1/)

مطالب و لینک های پیش رو می توانند در دسته بندی ۱) کامل نشده ۲) *نیاز به خواند* در نظر گرفته شوند، شخص من معمولا با شیوه کد نویسی  این نویسنده ها موافق نبودم و اما یک چیز واضح 
است و آن اینکه این  که قاطعیت و صراحت آنان است. علاوه بر این، این ها صاحب اختیاران این زبان هستند.
...
### پروسه‌ی ساخت ‌(Build) و توسعه (Development)
